"""
Trader3 — OSMIUM: skew=2 (light inventory tilt).
PEPPER: baseline buy-and-hold.
Hypothesis: baseline uses skew=3; test whether a lighter tilt lets us capture more
make-side fills without too much one-sided risk.
"""
import json
