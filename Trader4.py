"""
Trader4 — OSMIUM: skew=5 (heavy inventory tilt).
PEPPER: baseline buy-and-hold.
Hypothesis: a stronger push to flatten inventory reduces drawdown on random-walk
noise. Complement to Trader2/3 to bracket the optimum.
"""
import json
