"""
Trader6 — OSMIUM: no 'flatten at FV' step.
PEPPER: baseline buy-and-hold.
Hypothesis: mean reversion means flattening at FV gives up the very mean reversion
we'd profit from. Removing it should let winners run; skew still caps risk.
"""
import json
...
class Trader:
    ...
    def trade_osmium(self, product, order_depth, position, limit):
        ...
        for bid_price in sorted(order_depth.buy_orders.keys(), reverse=True):
            ...
            sell_vol += qty
        # NOTE: flatten-at-FV block intentionally removed
